              ...
              {tiles.map((tile) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      'aspect-square rounded-md border text-4xl leading-none transition-all md:text-5xl focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950',
                      tile.matched
